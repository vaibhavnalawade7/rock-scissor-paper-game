...
var computerScoreDisplay = document.getElementById("computerScore").getElementsByTagName("b")[0];
var userScoreDisplay = document.getElementById("userScore").getElementsByTagName("b")[0];
